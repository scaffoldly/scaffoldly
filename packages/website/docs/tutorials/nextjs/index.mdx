...
TODO: You may use other methods. See [AWS](/docs/cloud/aws) for more information.
...
- [Move configuration into `package.json`](/docs/config#package-json): Allowing you to remove the need for `--preset` on your `scaffoldly` commands.
- [Optimize the Image Size](/docs/config/presets/nextjs/output-modes): Allowing your app to load faster.
